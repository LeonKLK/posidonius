...
pub const DBL_EPSILON: f64 = 2.220_446_049_250_313e-16; // https://en.wikipedia.org/wiki/Machine_epsilon
...
pub const M2EARTH: f64 = 332_946.050_895; // ratio sun/earth mass
...
pub const AU: f64 = 1.495_978_707_00e11; // m
pub const M2AU: f64 = 1. / AU; // 6.684587122268445e-12 AU (1 meter in AU)
pub const SPEED_OF_LIGHT: f64 = (2.997_924_58e8 / AU) * DAY; // 173.14463267424034 AU/day
...
// Solar system
pub const SUN_DYN_FREQ_2: f64 = K2 / (R_SUN * R_SUN * R_SUN); // Needed for MathisSolarLike
...
pub const BOLTZMANN_CONSTANT_SI: f64 = 1.380_649e-23; // J.K-1
pub const MASS_HYDROGEN_ATOM_SI: f64 = 1.672_162_841e-27; // kg
