...
fn solar_like_baraffe1998_case() -> posidonius::WHFast {
    ...
    let star =
        common::stars::solar_like(star_mass, star_evolution, general_relativity_implementation);
