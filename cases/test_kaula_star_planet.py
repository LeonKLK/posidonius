...
if __name__ == "__main__":
    ...
    time_step = 0.05 # days
    time_limit = 5000.*365.25 # 18.772866 *100.# 2.*365.25 #* 1.0e2 # days
    historic_snapshot_period = 10.*365.25 # 1.*365.25 # days
    recovery_snapshot_period = 500.*365.25 # days
    ...
    star_rotation_period = 2.9*24 # hours (original 3.3)
    ...
    planet_mass = 0.3285168664 * Mearth / posidonius.constants.M_SUN # Solar masses, this value is already in such unit (3.0e-6 solar masses = 1 earth mass)
    ...
    planet_longitude_ascending_node = planet_keplerian_orbital_elements[5]
    planet_spin = posidonius.calculate_spin(planet_angular_frequency, planet_inclination, planet_obliquity, longitude_ascending_node=planet_longitude_ascending_node)
    # planet_spin = posidonius.calculate_spin(planet_angular_frequency, planet_inclination, planet_obliquity, planet_longitude_ascending_node)
