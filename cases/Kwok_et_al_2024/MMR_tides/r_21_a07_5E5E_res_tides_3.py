...
if __name__ == "__main__":
    ...
    time_step = 0.3 # days, better choose 1/20 of the smallest orbital period
    ...
    star_rotation_period = 13.95*24 # hours (original 3.3)
    ...
    star_kaula_tidal_parameters_love_numbers = {
        ...
        "stellar_tide": 1,
        "spectrum_spin_rate": posidonius.constants.TWO_PI / (1.2 * posidonius.constants.DAY), # second^-1, see kaula.rs
    }
    ...
    a = 0.07030807305058832                # semi-major axis (in AU)
    e = 0.1490116846459893;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 1.6574274282597266 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 5.545579691837709 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    ...
    a = 0.11147909652513059                # semi-major axis (in AU)
    e = 0.0030349311701428714;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 1.6328580659633865 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 5.9721446721588025 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    q = a * (1.0 - e);                      # perihelion distance
    planet_position, planet_velocity = posidonius.calculate_cartesian_coordinates(planet_mass, q, e, i, p, n, l, masses=[star_mass], positions=[star_position], velocities=[star_velocity])
