...
if __name__ == "__main__":
    ...
    time_step = 0.05 # days
    time_limit = 1.5e6*365.25 # 18.772866 *100.# 2.*365.25 #* 1.0e2 # days
    ...
    disk_properties = {
        'inner_edge_distance': 0.025,  # AU - Embed both planets in the disk
        'outer_edge_distance': 50.0,   # AU - No change
        'lifetime': 2.0e5 * 365.25,    # Extended to 200,000 years
        'alpha': 5.0e-3,               # Reduced viscosity
        'surface_density_normalization': 0.05 * disk_surface_density_normalization_SI * (1.0 / posidonius.constants.M_SUN) * posidonius.constants.AU**2,  # Increased normalization
    ...
    # Second planet
    a = 0.05238423471               # semi-major axis (in AU)
    e = 0.00001;                               # eccentricity
    i = 0. * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 0. * posidonius.constants.DEG2RAD;  # argrument of pericentre (degrees)
    n = 0. * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
