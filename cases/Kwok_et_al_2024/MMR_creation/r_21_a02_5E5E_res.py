...
if __name__ == "__main__":
    ...
    a = 0.02025008118229853                # semi-major axis (in AU)
    e = 0.1544417653332767;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 3.598928747543587 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 0.26091992164316963 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    ...
    a = 0.032120013141297164                # semi-major axis (in AU)
    e = 0.002628247559503598;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 3.707699286118041 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 6.013377855029454 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    q = a * (1.0 - e);                      # perihelion distance
    planet_position, planet_velocity = posidonius.calculate_cartesian_coordinates(planet_mass, q, e, i, p, n, l, masses=[star_mass], positions=[star_position], velocities=[star_velocity])
