...
if __name__ == "__main__":
    ...
    star_data = np.loadtxt('./input/love_numbers/Aurelie_Stellar/alpha0.51600_P3p0_Ek3p75em6.txt',comments='#')
    ...
    star_kaula_tidal_parameters_love_numbers = {
        ...
        "stellar_tide": 1,
        "spectrum_spin_rate": posidonius.constants.TWO_PI / (3.0 * posidonius.constants.DAY),
    }
    ...
    planet_radius_of_gyration = np.sqrt(0.26389) # Jupiter type planet
    planet_mass = 1.*Mjup / posidonius.constants.M_SUN # Solar masses (3.0e-6 solar masses = 1 earth mass)
    planet_radius = 1.*Rjup / posidonius.constants.AU # Assume same average density with Earth's
