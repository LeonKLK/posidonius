...
if __name__ == "__main__":
    ...
    time_step =    0.05 # days, better choose 1/20 of the smallest orbital period
    #time_limit   = 4*time_step # days
    time_limit   =  365.25 * 1.5e7 # days
    ...
    #     'lifetime': 5.0e5 * 365.25e0, # days
    #     # 'alpha': 1.0e-2, # original value
    #     'alpha': 1.0,
    #     # 'surface_density_normalization': disk_surface_density_normalization_SI * (1.0/posidonius.constants.M_SUN) * posidonius.constants.AU**2, # Msun.AU^-2
    #     'surface_density_normalization': 50. * disk_surface_density_normalization_SI * (1.0/posidonius.constants.M_SUN) * posidonius.constants.AU**2, # This control the surface density distribution
    #     'mean_molecular_weight': 2.4,
    # }
    ...
    a = 0.019853266024218122                # semi-major axis (in AU)
    e = 0.08494476268351189;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 225.70475260227582 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 233.45977036047287 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    ...
    # planet_rotation_period = orbital_period*24/(1.0003) #24. # hours orbital_period/(1.0 + 1e-5) #24. # hours
    ...
    a = 0.03154745926018548                # semi-major axis (in AU)
    e = 0.008488151539055912;                               # eccentricity
    i = 0.0 * posidonius.constants.DEG2RAD;  # inclination (degrees)
    p = 42.5433428876959 * posidonius.constants.DEG2RAD; # longitude of perihelion (degrees)
    n = 0.0 * posidonius.constants.DEG2RAD;  # longitude of the ascending node (degrees)
    l = 134.41757841224458 * posidonius.constants.DEG2RAD;  # mean anomaly (degrees)
    q = a * (1.0 - e);                      # perihelion distance
    planet_position, planet_velocity = posidonius.calculate_cartesian_coordinates(planet_mass, q, e, i, p, n, l, masses=[star_mass], positions=[star_position], velocities=[star_velocity])
